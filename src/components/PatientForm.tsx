      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-border pb-6 md:pb-8">
        <div className="flex items-center gap-3 md:gap-5">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm md:text-xl mt-0.5 md:mt-2 font-medium">Gerencie o cadastro de usuários da UBSF</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="space-y-1">
              ...
              <CardDescription className="text-xs md:text-sm font-medium">
                {searchTerm ? "Resultados da busca no sistema" : "Últimos registros da UBSF"}
              </CardDescription>
            </div>
