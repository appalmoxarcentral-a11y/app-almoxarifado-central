-- Atualização de Segurança para Acesso Global de Pedidos (v2)
...
BEGIN
    ...
    USING (
        ...
        (
            ...
            (
                public.is_admin() OR 
                -- Verificação robusta de permissão JSONB
                (
    ...
    RAISE NOTICE 'Política de acesso global aos pedidos atualizada com robustez.';
END $$;
