-- 1. Atualiza a trigger que gera a nova fatura automaticamente
-- Agora ela busca o valor (amount) atualizado direto da tabela plans, 
...
-- 2. Cria uma função segura para o frontend sincronizar o status sem ser bloqueado pelo RLS
CREATE OR REPLACE FUNCTION public.force_sync_invoice_status(p_invoice_id UUID, p_new_status TEXT)
RETURNS VOID AS $$
BEGIN
